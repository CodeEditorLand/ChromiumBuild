...
function $fidl__align(size) {
	return (
		size +
		(($fidl__kAlignment - (size & $fidl__kAlignmentMask)) &
 ...
 * @param {number} ordinal
 */
$fidl_Encoder.prototype._encodeMessageHeader = function (
	ordinal,
	has_response,
) {
...
const _kTT_bool = {
	enc: function (e, o, v) {
		e.data.setInt8(o, v ? 1 : 0);
	},
	dec: function (d, o) {
		return d.data.getInt8(o) != 0;
	},
};

const _kTT_float32 = {
	enc: function (e, o, v) {
		e.data.setFloat32(o, v, $fidl__kLE);
	},
	dec: function (d, o) {
		return d.data.getFloat32(o, $fidl__kLE);
	},
};

const _kTT_float64 = {
	enc: function (e, o, v) {
		e.data.setFloat64(o, v, $fidl__kLE);
	},
	dec: function (d, o) {
		return d.data.getFloat64(o, $fidl__kLE);
	},
};
...
const _kTT_int8 = {
	...
	dec: function (d, o) {
		return d.data.getInt8(o);
	},
};

const _kTT_int16 = {
	enc: function (e, o, v) {
		e.data.setInt16(o, v, $fidl__kLE);
	},
	dec: function (d, o) {
		return d.data.getInt16(o, $fidl__kLE);
	},
};

const _kTT_int32 = {
	enc: function (e, o, v) {
		e.data.setUint32(o, v, $fidl__kLE);
	},
	dec: function (d, o) {
		return d.data.getInt32(o, $fidl__kLE);
	},
};
...
const _kTT_uint8 = {
	...
	dec: function (d, o) {
		return d.data.getUint8(o);
	},
};

const _kTT_uint16 = {
	enc: function (e, o, v) {
		e.data.setUint16(o, v, $fidl__kLE);
	},
	dec: function (d, o) {
		return d.data.getUint16(o, $fidl__kLE);
	},
};
...
const _kTT_uint32 = {
	...
	dec: function (d, o) {
		return d.data.getUint32(o, $fidl__kLE);
	},
};
...
const _kTT_String = {
	...
	dec: function (d, o) {
		...
		return $FidlJsUtf8ArrayToStr(
			new DataView(d.data.buffer, dataOffset, len),
		);
	},
};
